...
function exp_BDKAZ_2rule0_eval_expression(context) {
    // "NAT_IMPOSI" <> 'IMPOSE' AND "BATI_TN" = 'BATI'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('NAT_IMPOSI')  != 'IMPOSE') && (feature.get('BATI_TN')  == 'BATI'));
    } else {
        return ((feature.get('NAT_IMPOSI')  != 'IMPOSE') && (feature.get('BATI_TN')  == 'BATI'));
    }
}
...
function exp_BDKAZ_2rule1_eval_expression(context) {
    // "BATI_TN" = 'TERRAIN NU' AND "NAT_IMPOSI" <> 'IMPOSE'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('BATI_TN')  == 'TERRAIN NU') && (feature.get('NAT_IMPOSI')  != 'IMPOSE'));
    } else {
        return ((feature.get('BATI_TN')  == 'TERRAIN NU') && (feature.get('NAT_IMPOSI')  != 'IMPOSE'));
    }
}
...
function exp_BDKAZ_2rule2_eval_expression(context) {
    // "NAT_IMPOSI" = 'IMPOSE'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('NAT_IMPOSI')  == 'IMPOSE');
    } else {
        return (feature.get('NAT_IMPOSI')  == 'IMPOSE');
    }
}
...
function exp_RECENSEMENT_3rule0_eval_expression(context) {
    // "PROPRIETAIRE" IS NULL OR "LOYER_ANN_1" IS NULL

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('PROPRIETAIRE')  === null) || (feature.get('LOYER_ANN_1')  === null));
    } else {
        return ((feature.get('PROPRIETAIRE')  === null) || (feature.get('LOYER_ANN_1')  === null));
    }
}
...
function exp_RECENSEMENT_3rule1_eval_expression(context) {
    // "PROPRIETAIRE" IS NOT NULL

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('PROPRIETAIRE')  !== null);
    } else {
        return (feature.get('PROPRIETAIRE')  !== null);
    }
}